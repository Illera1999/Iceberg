...
public class IcebergTracker {
    ...
    public IcebergTracker() {
        ...
        icebergsData.add(new IcebergData(LocalDate.of(2018, Month.SEPTEMBER, 1), iceberg1, "88ºN 24'E", 9e9));
        icebergsData.add(new IcebergData(LocalDate.of(2018, Month.OCTOBER, 1), iceberg1, "80ºN 12'E", 8e8));
        icebergsData.add(new IcebergData(LocalDate.of(2018, Month.SEPTEMBER, 1), iceberg2, "77ºS 02'W", 7e7));
        icebergsData.add(new IcebergData(LocalDate.of(2018, Month.OCTOBER, 1), iceberg2, "78ºS 03'W", 6.5e7));
    }
